...
set traceFile [open traceWired.tr w]
set namTraceFile [open namWired.nam w]
...
for {set i 1} {$i < $B} {incr i} {
    ...
    $ns duplex-link $bottleNeckNodes([expr $i - 1]) $bottleNeckNodes($i) 1Gb 1s DropTail
