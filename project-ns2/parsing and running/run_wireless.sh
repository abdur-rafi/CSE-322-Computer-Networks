...
# elif [[ $1 == 1 ]]; then
    ...
    main="./stats/average/wireLess_rand_2"
...
for prate in  20kb 40kb 60kb 80kb 100kb
do
...
# ns wireless.tcl 20 20 3 40 1200 0 1 .5 10mb .05 test.tr test.nam 10
# ns offline.tcl 20 20 3 40 500 0 1 .5 10mb .05 test.tr test.nam 10